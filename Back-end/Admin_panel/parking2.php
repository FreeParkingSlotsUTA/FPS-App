	      			...
	      			<div class="close"><a href="javascript:void(0)" onclick="hide('light')"><img src="./images/32/103.png"></a></div>
	      				<div class="con">
	      					<form action='parking2entrance.php' method="post"> 
			      					Number of Entrance:
			       					<input name="entrance2new" placeholder="input new data" type="text" class="bk" onmouseout="this.className='bk'" onmousemove="this.className='bk1'" />
	      			...
	      			<div class="close"><a href="javascript:void(0)" onclick="hide('light2')"><img src="./images/32/103.png"></a></div>
	      				<div class="con">
	      					<form action='parking2exit.php' method="post"> 
			      					Number of Exit:
			       					<input name="exit2new" placeholder="input new data" type="text" class="bk" onmouseout="this.className='bk'" onmousemove="this.className='bk1'" />
								<input value="CONFIRM " type="submit" class="mod">
							</form>
	     				</div>
				</div>
	      			...
	      			<div class="close"><a href="javascript:void(0)" onclick="hide('light3')"><img src="./images/32/103.png"></a></div>
	      				<div class="con">
	      					<form action='parking2total.php' method="post"> 
			      					Total slots:
			       					<input name="total2new" placeholder="input new data" type="text" class="bk" onmouseout="this.className='bk'" onmousemove="this.className='bk1'" />
								<input value="CONFIRM " type="submit" class="mod">
							</form>
	     				</div>
				</div>
	      			...
	      			<div class="close"><a href="javascript:void(0)" onclick="hide('light4')"><img src="./images/32/103.png"></a></div>
	      				<div class="con">
	      					<form action='parking2free.php' method="post"> 
			      					Free Slots:
			       					<input name="free2new" placeholder="input new data" type="text" class="bk" onmouseout="this.className='bk'" onmousemove="this.className='bk1'" />
								<input value="CONFIRM " type="submit" class="mod">
							</form>
	     				</div>
				</div>
